...
/**
 * Created by sdelight on 5/29/15.
 */
@RestController
public final class Authenticator {
    ...
    @RequestMapping(value = blogRestURIConstants.LOGIN,method = RequestMethod.POST)
    public @ResponseBody String login(@PathVariable("serviceKey") String serviceKey, @PathVariable("username") String username, @PathVariable("password") String password ) throws LoginException {
